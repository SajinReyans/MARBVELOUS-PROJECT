...
// 5-step signup form for Sellers.
// Steps: Account → Business → Identity/KYC → Bank → Store
// Uses FormSidebar, FormInput, OtpInput, UploadBox, StepNavigation.
...
export default function SellerSignupPage() {
  ...
  function submit() { navigate('/success') } // TODO: connect to backend
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '40px 48px', display: 'flex', flexDirection: 'column' }}>
        ...
        {step === 0 && (
          <>
            ...
            <div style={grid}>
              ...
              <FormInput label="Password"         type="password" placeholder="Create password" value={form.password}       onChange={set('password')} />
        ...
        {step === 1 && (
          <>
            ...
            <p style={{ ...{ fontSize: '0.72rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.12em', color: 'var(--blue)', paddingBottom: 8, borderBottom: '1.5px solid var(--blue-light)' }, margin: '24px 0 16px' }}>
              Business Address
            </p>
        ...
        {step === 2 && (
          <>
            ...
            <div style={grid}>
              ...
              <div /> {/* spacer */}
              <UploadBox label="GST Certificate"               optional icon="📄" hint="Click to upload GST Certificate"               onChange={setFile('gstCert')} />
              <UploadBox label="Address Proof"                          icon="📋" hint="Click to upload Address Proof"                  onChange={setFile('addressProof')} />
              <UploadBox label="Business Registration Certificate" optional icon="🏢" hint="Click to upload Business Certificate"      onChange={setFile('bizRegCert')} />
            </div>
            <StepNavigation onBack={back} onNext={next} nextLabel="Next" />
          </>
        )}
